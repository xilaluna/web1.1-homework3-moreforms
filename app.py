...
def compliments_results():
    ...
    compliment_username = request.args.get('users_name')
    wants_compliments = request.args.get('wants_compliments')
    num_compliments = request.args.get('num_compliments')

    num_compliments = int(num_compliments)

    amount_of_compliments = random.sample(
        list_of_compliments, k=num_compliments)

    context = {
        'compliment_username': compliment_username,
        'wants_compliments': wants_compliments,
        'num_compliments': num_compliments,
        'amount_of_compliments': amount_of_compliments
...
def animal_facts():
    ...
    users_animal_select = request.args.get('animal')

    users_animal_fact = "None"

    if users_animal_select is not None:
        users_animal_fact = animal_to_fact[users_animal_select]

    context = {
        'animal_to_fact': animal_to_fact.keys(),
        'users_animal_fact': users_animal_fact
